...
class ImageClassifyTask(OFATask):
    def __init__(self, cfg: ImageClassifyConfig, src_dict, tgt_dict, data=None):
        ...
        if  getattr(self.cfg, 'img_ans2label_file', None) is not None:
            self.ans2label_dict = pickle.load(open(self.cfg.img_ans2label_file, "rb"))
